...
export default function NewInfoLanding() {
  return (
    <div className="w-fit cursor-pointer inline-flex items-center justify-center p-1 pr-3 mb-4 text-sm text-blue-800 dark:text-blue-200 rounded-full bg-blue-50 border border-blue-100 dark:border-blue-800 dark:bg-blue-900 font-[inter]" role="alert">
