...
// import { MorphingTexts } from "../morphing-text/morphText"
    ...
    return (
        ...
        >
            <div className="flex h-full flex-col justify-center gap-4">
                ...
                {/* <h1 className="text-3xl md:text-4xl font-bold text-center mb-10 font-[inter]">Meet Our Team</h1> */}
                <h1 className="pointer-events-none font-[inter] bg-linear-to-b from-black to-gray-300/80 bg-clip-text text-left text-3xl lg:text-5xl leading-none font-semibold whitespace-pre-wrap text-transparent dark:from-white dark:to-slate-900/10 tracking-[-1px] pb-4">The Minds<br />Behind Risenta</h1>
